...
import ditb.ycsb.measurements.Measurements;
import ditb.ycsb.measurements.exporter.MeasurementsExporter;
import ditb.ycsb.measurements.exporter.TextMeasurementsExporter;
...
public final class Client {
   ...
   * ditb.ycsb.measurements.exporter.TextMeasurementsExporter.
   */
  ...
  public static void usageMessage() {
    System.out.println("Usage: java ditb.ycsb.Client [options]");
    ...
    System.out.println("  -db dbname: specify the name of the DB to use (default: ditb.ycsb.BasicDB) - \n" +
    ...
    System.out.println("  " + WORKLOAD_PROPERTY + ": the name of the workload class to use (e.g. " +
        "ditb.ycsb.workloads.CoreWorkload)");
    System.out.println("");
  ...
  public static void main(String[] args) {
    ...
    String dbname = props.getProperty(DB_PROPERTY, "ditb.ycsb.BasicDB");
