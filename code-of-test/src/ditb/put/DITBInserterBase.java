...
public abstract class DITBInserterBase {
  ...
  public DITBInserterBase(Configuration conf, TableName tableName, String loadDataDir,
  ...
  abstract protected RunnableDataInserter getProperDataInserter(int id, int reportInterval,
  ...
  abstract public class RunnableDataInserter implements Runnable {
    ...
    public RunnableDataInserter(int id, int reportInterval,
    ...
    protected abstract void insertRecords(List<AbstractDITBRecord> record) throws IOException;
