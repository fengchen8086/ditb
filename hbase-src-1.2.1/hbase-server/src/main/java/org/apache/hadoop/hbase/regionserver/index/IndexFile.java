...
import org.apache.hadoop.hbase.regionserver.index.IndexKeyValue.IndexKeyComparator;
import org.apache.hadoop.hbase.security.access.CodeToClassAndBackFor96Migration;
...
public class IndexFile {
  ...
  private static class TheHbaseMapWritable<K, V> implements SortedMap<byte[], V>, Configurable,
      Writable,
     ...
     */
    public TheHbaseMapWritable(SortedMap<byte[], V> map) {
   ...
   */
  static class FileInfo extends TheHbaseMapWritable<byte[], byte[]> {
    ...
    /*
     * HbaseObjectWritableFor96Migration Constructor.
     */
    FileInfo() {
      super();
    }
