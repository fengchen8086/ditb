...
@VisibleForTesting @InterfaceAudience.Private public class ScanInfo {
  private byte[] family;
  ...
  public static final long FIXED_OVERHEAD = ClassSize.align(
      ClassSize.OBJECT + (2 * ClassSize.REFERENCE) + (2 * Bytes.SIZEOF_INT) + (4
          * Bytes.SIZEOF_LONG) + (3 * Bytes.SIZEOF_BOOLEAN));
