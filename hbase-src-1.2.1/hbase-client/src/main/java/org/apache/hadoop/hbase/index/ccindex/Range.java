...
public class Range {
  ...
  public Range copyRange() {
    ...
    if (this.endValue != null) ret.endValue = this.endValue.clone();
    ret.startType = this.startType;
    if (this.startValue != null) ret.startValue = this.startValue.clone();
  ...
  public String getContain() {
    ...
    if (startValue != null && startValue.length != 0 && endValue != null && endValue.length != 0
        && endType != null && startType != null) {
      int mark = 0;
      switch (valueType) {
      case STRING:
        if (Bytes.compareTo(endValue, startValue) <= 0) mark = 1;
        break;
      case INT:
        if (Integer.parseInt(Bytes.toString(endValue)) <= Integer
            .parseInt(Bytes.toString(startValue))) mark = 1;
        break;
      case LONG:
        if (Long.parseLong(Bytes.toString(endValue)) <= Long.parseLong(Bytes.toString(startValue)))
          mark = 1;
        break;
      case DOUBLE:
        if (Double.parseDouble(Bytes.toString(endValue)) <= Double
            .parseDouble(Bytes.toString(startValue))) mark = 1;
        break;
      default:
        break;
      }

      if (mark == 1) sb.append(" or ");
      else sb.append(" and ");
    }
  ...
  public String toString() {
    ...
    if (startValue != null && startValue.length != 0 && endValue != null && endValue.length != 0
      ...
      case STRING:
        ...
        break;
      case INT:
        if (Bytes.toInt(endValue) <= Bytes.toInt(startValue)) mark = 1;
        break;
      case LONG:
        if (Bytes.toLong(endValue) <= Bytes.toLong(startValue)) mark = 1;
        break;
      case DOUBLE:
        if (Bytes.toDouble(endValue) <= Bytes.toDouble(startValue)) mark = 1;
        break;
      default:
        break;
      }
    ...
    return sb.toString() + ",startTs:" + startTs + ",endTs:" + endTs + ",filterIfMissing:"
        + filterIfMissing + ",latestVersionOnly:" + latestVersionOnly;
  }
