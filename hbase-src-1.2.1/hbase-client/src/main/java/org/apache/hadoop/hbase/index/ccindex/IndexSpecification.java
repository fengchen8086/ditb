...
public class IndexSpecification implements Writable {
   ...
   */
  public IndexSpecification(TableName tableName, byte[] indexColumn) {
    this(tableName, indexColumn, IndexType.GSIndex);
  }
   ...
   */
  public IndexSpecification(TableName tableName, byte[] indexColumn, IndexType type) {
    ...
    if (this.indexType == IndexType.UDGIndex) {
  ...
  public IndexSpecification(byte[] indexColumn) {
    this(null, indexColumn, IndexType.GSIndex);
  }
  ...
  public Map<byte[], Set<byte[]>> getAdditionMap() {
    if (this.indexType != IndexType.UDGIndex || additionMap == null) {
      return null;
    }
  ...
  public boolean equals(Object arg0) {
    ...
    if (Bytes.equals(index.indexId, this.indexId) && (this.tableName == index.tableName
        || this.tableName.equals(index.tableName)) && index.indexType == this.indexType) {
      if (index.indexType != IndexType.UDGIndex) {
        return true;
      } else {
  ...
  public TableName getIndexTableName() {
    ...
    return TableName.valueOf(Bytes.add(this.tableName.getName(), Bytes.toBytes("-"), this.indexId));
  }
  ...
  public String getIndexTableNameAsString() {
    return getIndexTableName().toString();
  }
