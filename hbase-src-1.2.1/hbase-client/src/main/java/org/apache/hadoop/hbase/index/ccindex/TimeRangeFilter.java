...
public class TimeRangeFilter extends FilterBase {
   ...
   * @param endTs
   */
  public TimeRangeFilter(final byte[] family, final byte[] qualifier, final long startTs,
      final long endTs) {
    this.columnFamily = family;
    this.columnQualifier = qualifier;
    if (startTs != -1) this.startTs = startTs;
    if (endTs != -1) this.endTs = endTs;
  }
  ...
  public ReturnCode filterKeyValue(Cell keyValue) {
    if (matchingColumn(keyValue, columnFamily, columnQualifier)) {
